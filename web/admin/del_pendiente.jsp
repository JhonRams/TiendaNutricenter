                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="?pedido=<%=elem.getId()%>" class="btn btn-secondary">Ver Entrega</a></td>
                                </tr>
                                <%
                                    }
                                %>
...
<section class="full-tvn-1 " id="vtn-personal-nuevo">
    ...
    <div class="admin-editor">
        ...
        <form method="POST" action="../usuario_entrega" class="text-right pad2">
            <input type="hidden" value="<%=objventa.getId()%>" name="idEntrega">
            <button class="btn btn-success">Entregar Pedido</button>
        </form>
    </div>
</section>
